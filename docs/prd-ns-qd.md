...
- **Diverge:** operators A inversion, B archive whitespace, C Swanson ABC, D analogical transport, E atypical combination, F missing dimensions, G failure resurrection. No ranking. **A is default; B is supported but non-default and composition-gated; E is experimental, off by default, and composition-gated; C, D, F, and G are deferred.**
