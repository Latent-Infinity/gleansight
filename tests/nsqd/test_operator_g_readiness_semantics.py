...
MUTATIONS = (
    ...
    Mutation("inventory count", ("candidate_inventory", 0, "observed_count"), 2),
    Mutation("inventory reason", ("candidate_inventory", 0, "reason_code"), "forged"),
    Mutation(
        "locator",
        ("candidate_locators",),
        [{"locator": "admitted/forged.json#0", "observed_count": 1}],
    ),
